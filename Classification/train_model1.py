#This .py file is used to train model 1 of classification approach in report
...
log_dir = "C:\\Users\\101232163\\Downloads\\Assignment_2\\tensorboard_logs134_4000_224_1_4\\" #Path to save tensorboard log files
dir = "C:\\Users\\101232163\\Downloads\\Face_recognition_dataset\\classification_data" #Path to classification data folder
...
ALPHA = 1.0 #Width multiplier of network
...
def train_after_layer_base(mdl, layer_no, epochs, lr, previous_history, name):
    global TOTAL_EPOCHS
    mdl_base = mdl.get_layer('mobilenetv2_1.00_160')
...
model.save('saved_models134_160_1_0/'+name)

#train first 54 layers and top with a lower lr
name = "model_top_54_base"

history_2 = train_after_layer_base(model, 100, 6, 0.00001, history_1, name)
...
base_m = model.get_layer('mobilenetv2_1.00_160')
...
optimizers_and_layers = [(optimizers.Adam(0.0001), model.layers[-3:]), #The layers on top of the base
                         ...
                         (optimizers.Adam(0.00001), base_m.layers[20:50])] 

optimizer = tfa.optimizers.MultiOptimizer(optimizers_and_layers)
history_3 = compile_and_fit(model, 10, history_2, optimizer, name)

model_evaluate(model)
model.save_weights('./checkpoints134_160_1_0/'+name)


#Repeat above for 5 more epochs
name = "model_top_134_base_diff_lr_re"
history_4 = compile_and_fit(model, 5, history_3, optimizer, name)

model_evaluate(model)
model.save_weights('./checkpoints134_160_1_0/'+name)

#ABove with low lr 
name = "model_top_134_base_diff_lr_re_low"
...
optimizer = tfa.optimizers.MultiOptimizer(optimizers_and_layers)
history_5 = compile_and_fit(model, 5, history_4, optimizer, name)
